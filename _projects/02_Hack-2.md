...
tracks.head()
```
![image](https://AnthonyHoudaille.github.io/images/tracks.png){:height="100%" width="100%"}
...
plt.show()
```
![image](https://AnthonyHoudaille.github.io/images/words1.png){:height="100%" width="100%"}
...
plt.show()
```
![image](https://AnthonyHoudaille.github.io/images/words2.png){:height="100%" width="100%"}
...
plt.show()
```
![image](https://AnthonyHoudaille.github.io/images/words3.png){:height="100%" width="100%"}
...
plt.show()
```
![image](https://AnthonyHoudaille.github.io/images/wordcould.png){:height="100%" width="100%"}
